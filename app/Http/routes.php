...
Route::group(['prefix' => 'group', 'as' => 'group.'], function () {
    ...
    Route::post('/{post}/comment',['as'=>'post.comment.add','uses'=>'CommentController@postGroup']);
    Route::post('/{problem}/comment', ['as' => 'problem.comment.add', 'uses' => 'CommentController@problem']);
