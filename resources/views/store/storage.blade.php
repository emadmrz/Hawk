        ...
        <div class="row">
            <div class="show-item">
                ...
                <div class="col-sm-8 pull-right">
                    {!! Form::open(['route'=>'store.storage.buy', 'method'=>'get']) !!}
                    <div class="title">
                    ...
                    <div class="content">
                        ...
                        <div class="lists row">
                            ...
                            <div class="center-block">
                                <del class="discount">{{ number_format(Config::get('addonStorage.base_price')) }} تومان  </del>
                            </div>
                        </div>
                        ...
                        <div class="lists row">
                            ...
                            <div class="center-block">
                                <div class="price">{{ number_format(Config::get('addonStorage.base_price') - Config::get('addonStorage.base_price')*Config::get('addonStorage.discount')  ) }} تومان </div>
