        ...
        <div class="row">
            <div class="show-item">
                ...
                <div class="col-sm-8 pull-right">
                    {!! Form::open(['route'=>'store.questionnaire.buy', 'method'=>'get']) !!}
                    <div class="title">
                    ...
                    <div class="content">
                        ...
                        <div class="lists row">
                            ...
                            <div class="center-block">
                                <del class="discount">{{ number_format(Config::get('addonQuestionnaire.base_price')) }} تومان  </del>
                            </div>
                        </div>
                        ...
                        <div class="lists row">
                            ...
                            <div class="center-block">
                                <div class="price">{{ number_format(Config::get('addonQuestionnaire.base_price') - Config::get('addonQuestionnaire.base_price')*Config::get('addonQuestionnaire.discount')  ) }} تومان </div>
