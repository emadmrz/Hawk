...
@section('content')
        ...
        <div class="">
            <div class="panel panel-default share clearfix-xs  search-panel">
                ...
                <div class="panel-body search-box">
                    ...
                    {!! Form::open(['route'=>['profile.management.addon.poll.search', $poll->id],'method'=>'post', 'class'=>'form-horizontal']) !!}
    ...
    @if(isset($results) and count($results))
        {!! Form::open(['route'=>['profile.management.addon.poll.publish', $poll->id],'method'=>'post', 'class'=>'form-horizontal']) !!}
