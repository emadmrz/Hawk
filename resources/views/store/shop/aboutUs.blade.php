...
@section('content')
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            <div class="panel-heading panel-heading-gray title">درباره ما</div>
            <div class="panel-body  biopraphy article">
                ...
                {!! Form::model($shop, ['route'=>['profile.management.addon.shop.aboutus.update',$shop->id], 'method'=>'post']) !!}
                    {!! Form::textarea('about_us', null, ['class'=>'form-control textarea_summernote', 'rows'=>'10']) !!}
