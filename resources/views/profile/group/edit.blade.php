...
@section('content')
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            <div class="panel-heading panel-heading-gray title">ویرایش گروه </div>
            <div class="panel-body">
                {!! Form::model($group,['route'=>['profile.group.update',$group->id], 'method'=>'post', 'enctype'=>"multipart/form-data"]) !!}
                <div class="clearfix form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-10 col-sm-offset-1">
                            <div id="crop_image_preview"><img src="{{ asset('img/files/') }}/{{$group->banner}}"></div>
                        </div>
                    </div>

                    <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-save"></i>ثبت تغیییرات </button>
