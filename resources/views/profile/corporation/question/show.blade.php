            ...
            <div class="panel-body">
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th width="5%" class="text-right">سوال</th>
                        <th width="5%" class="text-right">جواب</th>
                        <th width="5%" class="text-right">پاسخ دهنده</th>
                        <th width="5%" class="text-right">تاریخ پاسخ</th>
