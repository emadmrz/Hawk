...
return [
    'title'=>'افزایش حجم',
    'slug'=>'افزایش حجم به میزان 100MB',
    ...
    'attributes'=>[
        1 => [
            'name'=>'capacity',// Important value
            'title'=>'افزایش حجم',
            'values'=>[
                1 => ['name'=>'100 مگابایت','add_price'=>2000,'volume'=>100],
                2 => ['name'=>'300 مگابایت','add_price'=>4000,'volume'=>300],
                3 => ['name'=>'600 مگابایت','add_price'=>6000,'volume'=>600],
            ],
        ]
    ]
