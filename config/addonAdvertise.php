...
return [
    ...
    'attributes'=>[
        1 => [
            ...
            'title'=>'نوع تبلیغ ',
            'values'=>[
                1 => ['name'=>'طلایی','add_price'=>6000,'type'=>1, 'max'=>1, 'weight'=>0.2], // #1 gold
                2 => ['name'=>'نقره ایی','add_price'=>4000,'type'=>2, 'max'=> 2, 'weight'=>0.1], // #2 silver
                3 => ['name'=>'برونزی','add_price'=>2000,'type'=>3, 'max'=> 16, 'weight'=>0.05], // #3 bronze
            ],
        ]
    ]
