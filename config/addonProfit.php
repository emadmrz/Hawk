 ...
 * addon profit config variables
 */
return [
    'title'=>'افزایش رتبه',
    'slug'=>'افزایش رتبه در جستجو پیشرفته',
    'banner'=>'stock-vector-hard-drive-icons-113343430.jpg',
    'base_price'=>2000,
    'images'=>[
    ...
    'attributes'=>[
        1 => [
            ...
            'title'=>'افزایش رتبه',
            'values'=>[
                1 => ['name'=>'کاربر طلایی','add_price'=>6000,'qualification'=>1,'weight'=>1.5],
                2 => ['name'=>'کاربر نقره ای','add_price'=>4000,'qualification'=>2,'weight'=>1.35],
                3 => ['name'=>'کاربر برنزی','add_price'=>2000,'qualification'=>3,'weight'=>1.20],
            ],
        ]
    ]
